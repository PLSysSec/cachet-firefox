...
template <typename MemberCallArgs>
[[nodiscard]] bool GenericMember(JSContext* const cx, const unsigned argc,
                                 Value* const vp) {
  const CallArgs args(CallArgsFromVp(argc, vp));

  const RootedObject obj(cx, RequireObject(cx, args.thisv()));
  if (!obj) {
    return false;
  }

  const JSJitInfo* const info(FUNCTION_VALUE_TO_JITINFO(args.calleev()));
  return MemberCallArgs(args).call(cx, info, obj, nullptr);
}

[[nodiscard]] bool GenericGetter(JSContext* const cx, const unsigned argc,
                                 Value* const vp) {
  return GenericMember<JSJitGetterCallArgs>(cx, argc, vp);
}

[[nodiscard]] bool GenericSetter(JSContext* const cx, const unsigned argc,
                                 Value* const vp) {
  return GenericMember<JSJitSetterCallArgs>(cx, argc, vp);
}

[[nodiscard]] bool GenericMethod(JSContext* const cx, const unsigned argc,
                                 Value* const vp) {
  return GenericMember<JSJitMethodCallArgs>(cx, argc, vp);
}

template <typename T>
void ReportIncompatibleProto(
    JSContext* const cx, const HandleObject obj, const char* memberName,
...
template <typename T>
[[nodiscard]] Handle<T*> UnwrapThisObject(
    JSContext* const cx, const HandleObject obj, const char* memberName,
    const unsigned errorNumber = JSMSG_INCOMPATIBLE_PROTO) {
  if (!obj->is<T>()) {
...
class CacheKindObject : public NativeObject {
 ...
 private:
  [[nodiscard]] static bool nameGetter(JSContext* const cx,
                                       const HandleObject obj, void* const self,
                                       JSJitGetterCallArgs args) {
    const Handle<CacheKindObject*> kindObj(
        UnwrapThisObject<CacheKindObject>(cx, obj, "name"));
    if (!kindObj) {
      return false;
    }
  ...
  static constexpr JSJitInfo nameGetterInfo = {
      {.getter = nameGetter},
      {0},                  /* protoID */
      {0},                  /* depth */
      JSJitInfo::Getter,    /* type */
      JSJitInfo::AliasNone, /* aliasSet */
      JSVAL_TYPE_STRING,    /* returnType */
      false,                /* isInfallible */
      false,                /* isMovable */
  ...
  [[nodiscard]] static bool inputsGetter(JSContext* const cx,
                                         ...
                                         JSJitGetterCallArgs args) {
    const Handle<CacheKindObject*> kindObj(
        UnwrapThisObject<CacheKindObject>(cx, obj, "inputs"));
    if (!kindObj) {
      return false;
    }
  ...
  static constexpr JSJitInfo inputsGetterInfo = {
      {.getter = inputsGetter},
      {0},                  /* protoID */
      {0},                  /* depth */
      JSJitInfo::Getter,    /* type */
  ...
  [[nodiscard]] static bool outputGetter(JSContext* const cx,
                                         ...
                                         JSJitGetterCallArgs args) {
    const Handle<CacheKindObject*> kindObj(
        UnwrapThisObject<CacheKindObject>(cx, obj, "output"));
    if (!kindObj) {
      return false;
    }
  ...
  static constexpr JSJitInfo outputGetterInfo = {
      {.getter = outputGetter},
      {0},                  /* protoID */
      {0},                  /* depth */
      JSJitInfo::Getter,    /* type */
  ...
  static constexpr JSJitInfo toStringTagGetterInfo = {
      {.getter = toStringTagGetter},
      {0},                  /* protoID */
      {0},                  /* depth */
      JSJitInfo::Getter,    /* type */
      JSJitInfo::AliasNone, /* aliasSet */
      ...
      false,                /* isLazilyCachedInSlot */
      false,                /* isTypedMethod */
      TO_STRING_TAG_SLOT    /* slotIndex */
  };

  static constexpr JSPropertySpec properties[] = {
      JSPropertySpec::nativeAccessors("name", JSPROP_ENUMERATE, GenericGetter,
                                      &nameGetterInfo),
      JSPropertySpec::nativeAccessors("inputs", JSPROP_ENUMERATE, GenericGetter,
                                      &inputsGetterInfo),
      JSPropertySpec::nativeAccessors("output", JSPROP_ENUMERATE, GenericGetter,
                                      &outputGetterInfo),
      JSPropertySpec::nativeAccessors(JS::SymbolCode::toStringTag, 0,
                                      GenericGetter, &toStringTagGetterInfo),
      JS_PS_END};
...
class ICObject : public NativeObject {
 ...
 private:
  ...
  [[nodiscard]] static bool kindGetter(JSContext* const cx,
                                       const HandleObject obj, void* const self,
                                       JSJitGetterCallArgs args) {
    const Handle<ICObject*> icObj(UnwrapThisObject<ICObject>(cx, obj, "kind"));
    if (!icObj) {
      return false;
    }
  ...
  static constexpr JSJitInfo kindGetterInfo = {
      {.getter = kindGetter},
      {0},                  /* protoID */
      {0},                  /* depth */
      JSJitInfo::Getter,    /* type */
  ...
  static constexpr JSPropertySpec properties[] = {
      JSPropertySpec::nativeAccessors("kind", JSPROP_ENUMERATE, GenericGetter,
                                      &kindGetterInfo),
      JS_PS_END};
  ...
  static constexpr JSJitInfo generateStubMethodInfo = {
      {.method = generateStubMethod},
      {0},                        /* protoID */
      {0},                        /* depth */
  ...
  [[nodiscard]] static bool generateMegamorphicStubMethod(
      JSContext* const cx, const HandleObject obj, void* const self,
      const JSJitMethodCallArgs& args);

  static constexpr JSJitInfo generateMegamorphicStubMethodInfo = {
      {.method = generateMegamorphicStubMethod},
      {0},                        /* protoID */
      {0},                        /* depth */
      JSJitInfo::Method,          /* type */
      JSJitInfo::AliasEverything, /* aliasSet */
  ...
  static constexpr JSFunctionSpec methods[] = {
      JS_FNINFO("generateStub", GenericMethod, &generateStubMethodInfo, 0,
                JSPROP_ENUMERATE),
      JS_FNINFO("generateMegamorphicStub", GenericMethod,
                &generateMegamorphicStubMethodInfo, 0, JSPROP_ENUMERATE),
      JS_FS_END};
...
class ICStubObject : public NativeObject {
 ...
 private:
  ...
  [[nodiscard]] static bool kindGetter(JSContext* const cx,
                                       const HandleObject obj, void* const self,
                                       JSJitGetterCallArgs args) {
    const Handle<ICStubObject*> icStubObj(
        UnwrapThisObject<ICStubObject>(cx, obj, "kind"));
    if (!icStubObj) {
      return false;
    }
  ...
  [[nodiscard]] static bool toStringMethod(JSContext* const cx,
                                           ...
                                           const JSJitMethodCallArgs& args) {
    const Handle<ICStubObject*> icStubObj(
        UnwrapThisObject<ICStubObject>(cx, obj, "toString"));
    if (!icStubObj) {
      return false;
    }
  ...
  static constexpr JSJitInfo toStringMethodInfo = {
  ...
  static constexpr JSFunctionSpec methods[] = {
      JS_FNINFO("toString", GenericMethod, &toStringMethodInfo, 0,
                JSPROP_ENUMERATE),
      JS_FS_END};
...
class IonICObject : public ICObject {
 ...
 private:
  ...
  [[nodiscard]] static bool generateStubMethodImpl(
      JSContext* const cx, const HandleObject obj,
      const JSJitMethodCallArgs& args,
      const ICState::Mode mode = ICState::Mode::Specialized,
      const char* methodName = "generateStub",
      const char* functionName = "IonIC.prototype.generateStub") {
    const Handle<IonICObject*> ionICObj(
        UnwrapThisObject<IonICObject>(cx, obj, methodName));
    if (!ionICObj) {
      return false;
    }
  ...
  [[nodiscard]] static bool generateStubMethod(
      JSContext* const cx, const HandleObject obj, void* const self,
      const JSJitMethodCallArgs& args) {
    return generateStubMethodImpl(cx, obj, args);
  }
  ...
  [[nodiscard]] static bool generateMegamorphicStubMethod(
      JSContext* const cx, const HandleObject obj, void* const self,
      const JSJitMethodCallArgs& args) {
    return generateStubMethodImpl(cx, obj, args, ICState::Mode::Megamorphic,
                                  "generateMegamorphicStub",
...
[[nodiscard]] bool ICObject::generateStubMethod(
    JSContext* const cx, const HandleObject obj, void* const self,
    const JSJitMethodCallArgs& args) {
  if (obj->is<IonICObject>()) {
    return IonICObject::generateStubMethod(cx, obj, self, args);
  }
...
[[nodiscard]] bool ICObject::generateMegamorphicStubMethod(
    JSContext* const cx, const HandleObject obj, void* const self,
    const JSJitMethodCallArgs& args) {
  if (obj->is<IonICObject>()) {
    return IonICObject::generateMegamorphicStubMethod(cx, obj, self, args);
  }
...
static JSObject* NewGlobalObject(JSContext* cx, JS::RealmOptions& options,
...

  {
    ...
    RootedObject domProto(
        cx,
        JS_InitClass(cx, glob, &dom_class, nullptr, &dom_class, dom_constructor,
