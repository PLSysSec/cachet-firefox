...
# This script generates jit/CacheIRGenerated.h from CacheIR.yaml.
...
def generate_cacheir_header(c_out, yaml_path):
    ...
    contains a list of all CacheIR ops, kinds, and types, and generated source
    code for CacheIRCompiler, CacheIRWriter, CodeGenerator, IonCacheIRCompiler,
    and IonICObject."""
    ...
    for name, op in data["cache_ops"].items():
        args = op["args"]
    ...
    for name, kind in data["cache_kinds"].items():
